class ListingsController < ApplicationController
  ...
  private
    ...
    def listing_params
      params.expect(listing: [ :user_id, :title, :description, :category, :condition, :status, :selling_type, :quantity, :starting_price_cents, :reserve_price_cents, :buy_now_price_cents, :auction_ends_at, :shipping_type, :shipping_price_cents, :currency ])
    end
end
